...
def main():
	...
	parser.add_option("-t","--wigsum",action="store",type="int",dest="total_wigsum",help="Specified wigsum. 100000000 equals to coverage of 1 million 100nt reads. Ignore this option to disable normalization")
	parser.add_option("-u","--skip-multi-hits",action="store_true",dest="skip_multi",help="Presence this option render the program to skip multiple hit reads.")
	...
	obj = SAM.ParseBAM(options.input_file)		
	obj.bamTowig(outfile = options.output_prefix, chrom_sizes = chromSizes, skip_multi=options.skip_multi,strand_rule = options.strand_rule, WigSumFactor=norm_factor)
